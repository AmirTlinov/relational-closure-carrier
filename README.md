...
- **[Technical extended abstract](TECHNICAL_ABSTRACT.md)** — the denser causal account and full controls narrative.
...
The implementation uses one local collision kernel and explicit relation handles. Address relabeling preserves the result; shuffling the placement of the history-bearing relations erases the A/B future difference.
